...
CREATE USER 'pmg_dev_user'@'%' IDENTIFIED BY 'pmouseguru';
CREATE USER 'pmg_prod_user'@'%' IDENTIFIED BY 'pmouseguru';
...
GRANT SELECT ON pmg_dev.* to 'pmg_dev_user'@'%';
GRANT INSERT ON pmg_dev.* to 'pmg_dev_user'@'%';
GRANT DELETE ON pmg_dev.* to 'pmg_dev_user'@'%';
GRANT UPDATE ON pmg_dev.* to 'pmg_dev_user'@'%';
GRANT SELECT ON pmg_prod.* to 'pmg_prod_user'@'%';
GRANT INSERT ON pmg_prod.* to 'pmg_prod_user'@'%';
GRANT DELETE ON pmg_prod.* to 'pmg_prod_user'@'%';
GRANT UPDATE ON pmg_prod.* to 'pmg_prod_user'@'%';